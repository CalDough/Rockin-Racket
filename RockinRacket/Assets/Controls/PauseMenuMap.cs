...
public partial class @PauseMenuMap: IInputActionCollection2, IDisposable
{
    ...
    {
        private @PauseMenuMap m_Wrapper;
        public PauseMenuActions(@PauseMenuMap wrapper) { m_Wrapper = wrapper; }
