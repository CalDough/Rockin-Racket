...
Honestly man, sometimes I just zone out and let muscle memory from practicing take over. It's been working out so far.
    ...
    * [There's no way]
    ...
    #speaker: Ace #portrait: harvey_chill_normal #portrait: ace_speaking_normal
    I'm telling you man. I hit a state of zen and everything just flows. It's smooth and sweet, like a smoothie. You'll get there eventually yourself man.
        -> END
    ...
    * [That can't be good]
    ...
    #speaker: Ace #portrait: harvey_chill_normal #portrait: ace_speaking_normal
    Nah. We talked about it one night during practice and they all seemed cool with it. Or at least until I mess up, and then they might be mad at me for it. MJ did say that she'll smack me with her guitar if I screw up tho.
        -> END
